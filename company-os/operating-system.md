...
| **One constraint** | Name the one constraint this week and work that. Several ideas may attack the same constraint. | A second ritual, channel, or agent team that does not attack it is busywork. |
