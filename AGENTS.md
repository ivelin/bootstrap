...
11. **Founder lock — login on pirin.ai only.** Login and OAuth for hosted identity live on pirin.ai (`/bootstrap-os/login`, Web Builder). This repo owns MCP + SQL + `bootstrap-os-mcp` env/preview. Do not add a login UI here.
