...
description: Pin OS house rules by link. Spoken yes / GTM, volume, security program, second idea, optimal price, handful WTP, 0-1 LTV/CAC, old SaaS playbook, automate the playbook, agent team with no named owner, new landing page, legal paper, advisor ride-along.
---

# House-rule pins

When to use: GTM; spoken yes; volume; security program; second idea; optimal price; handful WTP; LTV/CAC at 0-1; old SaaS playbook; automate the playbook; agent team to skip a step with no named owner; one bottleneck this week; new landing page; legal paper; advisor ride-along.
