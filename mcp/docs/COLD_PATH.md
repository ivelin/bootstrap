...
Expected: typecheck, build, unit tests (including OS 2.8.9 house rules and the [E2E role-play matrix](E2E_ROLEPLAY.md)), cold-path smoke, **stdio MCP client smoke**, **HTTP hosted-read smoke** all pass.
