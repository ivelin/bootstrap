...
Expected: typecheck, build, unit tests (including OS 2.8.9 house rules, the [E2E role-play matrix](E2E_ROLEPLAY.md), and [invite/accept](INVITE.md)), cold-path smoke, **stdio MCP client smoke**, **HTTP hosted-read smoke** all pass.
